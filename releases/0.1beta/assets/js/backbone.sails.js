...
(function() {
  ...
  (function(Backbone, $, _) {
      ...
      Model.prototype.fetch = function(key, options, internal) {
        ...
        if (_.isString(key)) {
          if (this.assoc[key] == null) {
            ...
            defer = $.Deferred();
            instance = new this.assoc[key](this.get(key), options);
    ...
    FakeModel = (function(_super) {
      ...
      function FakeModel() {
        _ref = FakeModel.__super__.constructor.apply(this, arguments);
        return _ref;
      }
    ...
    Sails.Collection = (function(_super) {
      ...
      Collection.prototype.message = function(namespace, data, options, internal) {
        var coll, idAttr, key, model, request, result, state, url, _i, _j, _k, _len, _len1, _len2, _ref1, _ref2, _ref3, _ref4;
        coll = this;
        ...
        if (state === 'server') {
          ...
          _ref2 = keys.collectionQuery;
          for (_j = 0, _len1 = _ref2.length; _j < _len1; _j++) {
            key = _ref2[_j];
            options[key] = false;
          }
          options.where = {};
          idAttr = ((_ref3 = coll.at(0)) != null ? _ref3.idAttribute : void 0) || 'id';
    ...
    FakeCollection = (function(_super) {
      ...
      function FakeCollection() {
        _ref1 = FakeCollection.__super__.constructor.apply(this, arguments);
        return _ref1;
      }
